<div class="main-sidebar sidebar-style-2">
  <aside id="sidebar-wrapper">
    ...
    <div class="sidebar-brand normal-logo">
      <a href="{{ url('/rw/dashboard-rw') }}" class="d-flex align-items-center justify-content-center">
    ...
    <div class="sidebar-brand sidebar-brand-sm collapsed-logo">
      <a href="{{ url('/rw/dashboard-rw') }}">
        <img src="{{ asset('storage/logo/logo.png') }}" alt="Logo Kecil" style="height:35px; margin-left:5px;">
      </a>
    </div>

    <ul class="sidebar-menu">
      <li><a href="{{ url('/rw/dashboard-rw') }}" class="nav-link"><i class="fas fa-home"></i><span>Dashboard</span></a></li>
      <!-- Pengajuan Surat -->
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          <li><a href="{{ url('rw/suratmasuk-rw') }}" class="nav-link">Surat Masuk</a></li>
          <li><a href="{{ url('rw/suratselesai-rw') }}" class="nav-link">Surat Selesai</a></li>
        </ul>
      </li>
    </ul>
